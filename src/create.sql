...
ALTER TABLE `Samples` ADD INDEX `AdsBlockedGoogle` (`AdsBlockedGoogle`) USING HASH;
ALTER TABLE `Samples` ADD INDEX `AdsBlockedBanner` (`AdsBlockedBanner`) USING HASH;
ALTER TABLE `Samples` ADD INDEX `AdsBlockedScript` (`AdsBlockedScript`) USING HASH;
ALTER TABLE `Samples` ADD INDEX `LikeShareFacebook` (`LikeShareFacebook`) USING HASH;
ALTER TABLE `Samples` ADD INDEX `LikeShareTwitter` (`LikeShareTwitter`) USING HASH;
ALTER TABLE `Samples` ADD INDEX `LikeShareReddit` (`LikeShareReddit`) USING HASH;
...
ALTER TABLE `Samples` ADD INDEX `TouchPoints` (`TouchPoints`) USING HASH;
