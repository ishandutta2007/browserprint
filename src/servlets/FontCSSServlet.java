...
public class FontCSSServlet extends HttpServlet {
    ...
    public FontCSSServlet() {
        ...
        String fonts[] = new String[] {
        		...
        		//Note: we removed the _ from MingLiU_HKSCS and other fonts replacing it with a space. This is to fix a bug.
        		"Microsoft Uighur", "Microsoft YaHei", "Microsoft Yi Baiti", "MingLiU", "MingLiU HKSCS", "MingLiU HKSCS-ExtB", "MingLiU-ExtB", "Minion", "Minion Pro", "Miriam", "Miriam Fixed", "Mistral", "Modern", "Modern No. 20", "Mona Lisa Solid ITC TT", "Mongolian Baiti",
        ...
        expectedFonts = new HashSet<String>(fonts.length);
