...
--%><%@attribute name="predictionBean1" required="true" type="beans.PredictionBean" rtexprvalue="true"%><%--
...
--%><%@attribute name="predictionBean2" required="true" type="beans.PredictionBean" rtexprvalue="true"%><%--
