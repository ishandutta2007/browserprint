...
--%><jsp:useBean id="chrsBean2" class="beans.CharacteristicsBean" scope="request" /><%--
--%><jsp:useBean id="uniquenessBean2" class="beans.UniquenessBean" scope="request" /><%--
			...
			<div style="float:right;">
				<div class="sampleBox">
					...
					<select name="sampleUUID2" id="historySelector2" class="historySelect"><%--
						--%><common:historyOptions historyListBean="${ historyListBean }" sampleUUID="${ param.sampleUUID2 }" />
					</select>
					<script type="text/javascript">
